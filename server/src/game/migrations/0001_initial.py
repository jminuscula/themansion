# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-07 10:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_phase', models.CharField(choices=[('passive', 'PASSIVE'), ('voting', 'VOTING'), ('night', 'NIGHT'), ('room', 'ROOM'), ('day', 'DAY')], max_length=16, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger', models.CharField(choices=[('endgame', 'ENDGAME'), ('terrorize', 'TERRORIZE'), ('kill', 'KILL'), ('execute', 'EXECUTE'), ('terrorized', 'TERRORIZED'), ('executed', 'EXECUTED'), ('killed', 'KILLED')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_day', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='current_day', to='game.Day')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('special', 'SPECIAL'), ('attack_blank', 'ATTACK_BLANK'), ('open_door', 'OPEN_DOOR'), ('attack_defend', 'ATTACK_DEFEND'), ('attack_kill', 'ATTACK_KILL'), ('move', 'MOVE'), ('close_door', 'CLOSE_DOOR'), ('pick_weapon', 'PICK_WEAPON')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('room_type', models.CharField(choices=[('dormitory', 'DORMITORY'), ('observatory', 'OBSERVATORY'), ('hall', 'HALL'), ('kitchen', 'KITCHEN'), ('basic', 'BASIC'), ('library', 'LIBRARY'), ('basement', 'BASEMENT')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=256)),
                ('weapon_type', models.CharField(choices=[('gun', 'GUN'), ('knife', 'KNIFE'), ('stunt', 'STUNT'), ('poison', 'POISON')], max_length=16)),
        ...
        migrations.AddField(
            model_name='game',
            name='current_night',
            field=models.ForeignKey(blank=True, on_delete=django.db.models.deletion.PROTECT, related_name='current_night', to='game.Night'),
        ),
        migrations.AddField(
            model_name='game',
            name='game_players',
