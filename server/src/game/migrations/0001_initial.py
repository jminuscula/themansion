# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-09 08:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_phase', models.CharField(choices=[('voting', 'VOTING'), ('day', 'DAY'), ('room', 'ROOM'), ('passive', 'PASSIVE'), ('night', 'NIGHT')], max_length=16, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('attack_kill', 'ATTACK_KILL'), ('close_door', 'CLOSE_DOOR'), ('special', 'SPECIAL'), ('move', 'MOVE'), ('pick_weapon', 'PICK_WEAPON'), ('attack_blank', 'ATTACK_BLANK'), ('open_door', 'OPEN_DOOR'), ('attack_defend', 'ATTACK_DEFEND')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger', models.CharField(choices=[('executed', 'EXECUTED'), ('terrorized', 'TERRORIZED'), ('endgame', 'ENDGAME'), ('killed', 'KILLED'), ('execute', 'EXECUTE'), ('dead', 'DEAD'), ('kill', 'KILL'), ('terrorize', 'TERRORIZE')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('room_type', models.CharField(choices=[('basic', 'BASIC'), ('dormitory', 'DORMITORY'), ('kitchen', 'KITCHEN'), ('basement', 'BASEMENT'), ('observatory', 'OBSERVATORY'), ('hall', 'HALL'), ('library', 'LIBRARY')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=256)),
                ('weapon_type', models.CharField(choices=[('poison', 'POISON'), ('stunt', 'STUNT'), ('gun', 'GUN'), ('knife', 'KNIFE')], max_length=16)),
