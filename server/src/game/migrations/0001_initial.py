# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-08 10:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_phase', models.CharField(choices=[('night', 'NIGHT'), ('voting', 'VOTING'), ('passive', 'PASSIVE'), ('room', 'ROOM'), ('day', 'DAY')], max_length=16, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger', models.CharField(choices=[('execute', 'EXECUTE'), ('dead', 'DEAD'), ('kill', 'KILL'), ('terrorize', 'TERRORIZE'), ('killed', 'KILLED'), ('terrorized', 'TERRORIZED'), ('endgame', 'ENDGAME'), ('executed', 'EXECUTED')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('attack_blank', 'ATTACK_BLANK'), ('open_door', 'OPEN_DOOR'), ('move', 'MOVE'), ('pick_weapon', 'PICK_WEAPON'), ('special', 'SPECIAL'), ('attack_kill', 'ATTACK_KILL'), ('attack_defend', 'ATTACK_DEFEND'), ('close_door', 'CLOSE_DOOR')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('current_room', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='players_here', to='game.GameRoom')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('room_type', models.CharField(choices=[('hall', 'HALL'), ('dormitory', 'DORMITORY'), ('kitchen', 'KITCHEN'), ('basement', 'BASEMENT'), ('observatory', 'OBSERVATORY'), ('basic', 'BASIC'), ('library', 'LIBRARY')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=256)),
                ('weapon_type', models.CharField(choices=[('knife', 'KNIFE'), ('gun', 'GUN'), ('stunt', 'STUNT'), ('poison', 'POISON')], max_length=16)),
