# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-12 15:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_phase', models.CharField(choices=[('voting', 'VOTING'), ('day', 'DAY'), ('night', 'NIGHT'), ('room', 'ROOM'), ('startgame', 'STARTGAME')], max_length=16, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('number', models.IntegerField(default=0)),
                ('turns_left', models.IntegerField(default=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('special', 'SPECIAL'), ('attack_defend', 'ATTACK_DEFEND'), ('pick_weapon', 'PICK_WEAPON'), ('open_door', 'OPEN_DOOR'), ('move', 'MOVE'), ('attack_blank', 'ATTACK_BLANK'), ('attack_kill', 'ATTACK_KILL'), ('close_door', 'CLOSE_DOOR')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger', models.CharField(choices=[('killed', 'KILLED'), ('dead', 'DEAD'), ('endgame', 'ENDGAME'), ('terrorized', 'TERRORIZED'), ('executed', 'EXECUTED'), ('execute', 'EXECUTE'), ('kill', 'KILL'), ('terrorize', 'TERRORIZE')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('room_type', models.CharField(choices=[('kitchen', 'KITCHEN'), ('basement', 'BASEMENT'), ('hall', 'HALL'), ('basic', 'BASIC'), ('dormitory', 'DORMITORY'), ('observatory', 'OBSERVATORY'), ('library', 'LIBRARY')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=256)),
                ('weapon_type', models.CharField(choices=[('knife', 'KNIFE'), ('poison', 'POISON'), ('gun', 'GUN'), ('stunt', 'STUNT')], max_length=16)),
