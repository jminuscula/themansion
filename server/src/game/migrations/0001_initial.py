# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-09 16:38
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_phase', models.CharField(choices=[('startgame', 'STARTGAME'), ('room', 'ROOM'), ('night', 'NIGHT'), ('voting', 'VOTING'), ('day', 'DAY')], max_length=16, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('open_door', 'OPEN_DOOR'), ('pick_weapon', 'PICK_WEAPON'), ('attack_blank', 'ATTACK_BLANK'), ('attack_kill', 'ATTACK_KILL'), ('close_door', 'CLOSE_DOOR'), ('move', 'MOVE'), ('special', 'SPECIAL'), ('attack_defend', 'ATTACK_DEFEND')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger', models.CharField(choices=[('executed', 'EXECUTED'), ('killed', 'KILLED'), ('endgame', 'ENDGAME'), ('dead', 'DEAD'), ('execute', 'EXECUTE'), ('kill', 'KILL'), ('terrorized', 'TERRORIZED'), ('terrorize', 'TERRORIZE')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('room_type', models.CharField(choices=[('hall', 'HALL'), ('library', 'LIBRARY'), ('dormitory', 'DORMITORY'), ('basement', 'BASEMENT'), ('basic', 'BASIC'), ('observatory', 'OBSERVATORY'), ('kitchen', 'KITCHEN')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=256)),
                ('weapon_type', models.CharField(choices=[('poison', 'POISON'), ('knife', 'KNIFE'), ('gun', 'GUN'), ('stunt', 'STUNT')], max_length=16)),
