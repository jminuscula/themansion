# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2016-09-09 10:09
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('action_phase', models.CharField(choices=[('room', 'ROOM'), ('day', 'DAY'), ('voting', 'VOTING'), ('passive', 'PASSIVE'), ('night', 'NIGHT')], max_length=16, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('character', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='game.Character')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('action', models.CharField(choices=[('special', 'SPECIAL'), ('attack_defend', 'ATTACK_DEFEND'), ('move', 'MOVE'), ('attack_blank', 'ATTACK_BLANK'), ('pick_weapon', 'PICK_WEAPON'), ('close_door', 'CLOSE_DOOR'), ('open_door', 'OPEN_DOOR'), ('attack_kill', 'ATTACK_KILL')], max_length=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trigger', models.CharField(choices=[('killed', 'KILLED'), ('kill', 'KILL'), ('endgame', 'ENDGAME'), ('dead', 'DEAD'), ('terrorize', 'TERRORIZE'), ('executed', 'EXECUTED'), ('execute', 'EXECUTE'), ('terrorized', 'TERRORIZED')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=64, unique=True)),
                ('room_type', models.CharField(choices=[('basement', 'BASEMENT'), ('observatory', 'OBSERVATORY'), ('kitchen', 'KITCHEN'), ('hall', 'HALL'), ('basic', 'BASIC'), ('library', 'LIBRARY'), ('dormitory', 'DORMITORY')], max_length=16)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(max_length=256)),
                ('weapon_type', models.CharField(choices=[('knife', 'KNIFE'), ('poison', 'POISON'), ('stunt', 'STUNT'), ('gun', 'GUN')], max_length=16)),
        ...
        migrations.AddField(
            ...
            name='picked_at',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='game.GameRoom'),
        ),
        migrations.AddField(
            model_name='characterweapon',
            name='weapon',
